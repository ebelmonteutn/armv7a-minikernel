...
Este proyecto es un mini-kernel o sistema operativo "bare-metal" diseñado desde cero para la arquitectura de procesadores ARMv7-A. Fue desarrollado como parte de la materia **Técnicas Digitales II/III** de la Universidad Tecnológica Nacional, Facultad Regional Buenos Aires (UTN.BA).
